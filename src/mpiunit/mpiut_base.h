...
/* Time-stamp: <2007-11-14 22:36:49 shinya> */
...
{ CU_assertImplementation(((actual) == (expected)), __LINE__, ("CU_ASSERT_INT_EQUAL(" #actual "," #expected ")"), __FILE__, "", CU_FALSE); }

#define CU_ASSERT_INT_NOT_EQUAL(actual, expected) \
{ CU_assertImplementation(((actual) != (expected)), __LINE__, ("CU_ASSERT_INT_NOT_EQUAL(" #actual "," #expected ")"), __FILE__, "", CU_FALSE); }
