...
/*
 *  cspec_config.c   :  This file depends on the capabilities of your
 *hardware/platform
 *
 * In case your platform does not support double or provides another function to
...
double MPISpec_Fabs(double arg) { return fabs(arg); }
